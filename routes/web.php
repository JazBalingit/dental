...
Route::get('user-accounts', [AdminController::class, 'showUserAcc'])->name('userAcc');
...
Route::get('appointment-approval', [AdminController::class, 'showAppointmentApproval'])->name('appointmentApproval');
