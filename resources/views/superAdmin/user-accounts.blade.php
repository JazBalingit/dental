...
<body>
    ...
    @foreach ($users->merge($archivedUsers) as $acc)
        @php
            ...
            // Split the stored "Street, Barangay, City, Province" string back
            // into the 4 editable fields — best-effort for older freeform
            // addresses (the whole thing just lands in "Street").
