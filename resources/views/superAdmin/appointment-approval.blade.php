            ...
            <nav class="nav">
                ...
                <form method="POST" action="{{ route('logout') }}" class="m-0">
                    ...
                    <button type="submit" class="w-100 text-start border-0 bg-transparent"
                        style="all:unset; cursor:pointer; display:flex; align-items:center; gap:8px; padding: 8px 12px;">
                                ...
                                <div class="row g-3 mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-icon"><i class="bi bi-heart-pulse"></i><input type="text"
                                                class="form-control" value="{{ $appt->service->ServiceName ?? '' }}" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-icon"><i class="bi bi-clock"></i><input type="text"
                                                class="form-control" value="{{ $timeLabel }}" disabled /></div>
                                    </div>
                                    <div class="col-md-6">
