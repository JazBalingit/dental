...
class SystemSetting extends Model
{
    ...
    public static function aboutInfoDefaults(): array
    {
        return [
            ...
            'heroTitle' => 'PUS-PUS BRITANICO',
            'heroSubtitle' => 'Providing quality and affordable dental care.',
            'heroDescription' => 'Your smile is our priority. Experience compassionate, professional dental care in a welcoming environment.',
    ...
    public static function aboutInfo(): array
    {
        ...
        return [
            ...
            'heroTitle' => static::get('hero_title', $defaults['heroTitle']) ?: $defaults['heroTitle'],
            'heroSubtitle' => static::get('hero_subtitle', $defaults['heroSubtitle']) ?: $defaults['heroSubtitle'],
            'heroDescription' => static::get('hero_description', $defaults['heroDescription']) ?: $defaults['heroDescription'],
            'logo' => $defaults['logo'],
